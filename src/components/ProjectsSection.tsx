...
const projects: ProjectData[] = [
  {
    ...
    lead: 'A clinical dashboard that ranks diabetic patients by urgency, so a clinician sees the highest-risk cases first.',
    typeBadge: 'ML · Full-stack',
    statBadge: '94% accuracy',
    stack: ['React 19', 'Express', 'Supabase', 'Postgres', 'scikit-learn', 'Zod', 'Vercel'],
